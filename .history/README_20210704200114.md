...
$ curl -s https://raw.githubusercontent.com/nguyenduchoai/odoo-13/master/run.sh | sudo bash -s odoo-13-docker-compose-one 10013

# 2nd Odoo @ localhost:11013
$ curl -s https://raw.githubusercontent.com/nguyenduchoai/odoo-13/master/run.sh | sudo bash -s odoo-13-docker-compose-two 11013
```
